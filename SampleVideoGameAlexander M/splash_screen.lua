...
local jungleSounds = audio.loadSound("Sounds/jungleSounds.wav")
...
-- The function that moves turtle across the screen
...
function scene:create( event )
    ...
    turtle = display.newImageRect("Images/splashScreenTurtle.png", 200, 200)

    -- set the initial x and y position of the beetleship
    turtle.x = display.contentWidth
