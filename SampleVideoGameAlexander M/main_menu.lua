...
local mainMenuMusic = audio.loadSound("Sounds/mainMenu.mp3")
local mainMenuSoundsChannel
...
function scene:create( event )
    ...
    playButton = widget.newButton( 
        {   
            ...
            y = display.contentHeight*7/8 + 10,
...
function scene:show( event )
    ...
    elseif ( phase == "did" ) then       
        ...
        mainMenuSoundsChannel = audio.play( mainMenuMusic )
...
function scene:hide( event )
    ...
    elseif ( phase == "did" ) then
        ...
        audio.stop(mainMenuSoundsChannel)
    end
